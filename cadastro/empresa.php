...
<head>
  ...
  <title>Cadastro empresa - Retech</title>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-12 text-center">
          <h2 class="section-heading text-uppercase">Cadastro de empresa</h2>
          <h3 class="section-subheading text-muted">Preencha os campos do formulário abaixo</h3>
        </div>
      </div>

          <?php if (isset($_SESSION['bdEmpresa']) && $_SESSION['bdEmpresa'] == true): ?>
            <div class="alert alert-success" role="alert">
              Salvo com sucesso
            </div>
          <?php elseif(isset($_SESSION['bdEmpresa']) && $_SESSION['bdEmpresa'] == false): ?>
            <div class="alert alert-danger" role="alert">
              Ocorreu uma falha ao tentar salvar os dados
            </div>
          <?php endif; unset($_SESSION['bdEmpresa']) ?>
